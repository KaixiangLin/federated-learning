...
In this section, we study the convergence of accelerated FedAvg 
...
We now bound $C_1$, we set $\Lambda_{t_0} = \sum_{j=0}^{t_0 - 1}\beta^{t_0-1-j} = \frac{1 - \beta^{t_0}}{1- \beta} \leq \frac{1}{1 - \beta}$, \lkxcom{assume $\beta \in (0, 1)$ and set $\alpha \geq \beta$}.
\begin{align}
...
% \end{itemize}
% \begin{itemize}
% 	\item MGD vs NASGD: currently we use NASGD. 
% 	\begin{align}
