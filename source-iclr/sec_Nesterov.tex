...
\begin{theorem}
	...
	\end{align*}
\end{theorem}
The key step in the proof of this result is a one step contraction that involves three time steps, due to the update format of Nesterov SGD, but shares similar elements as that for FedAvg:
\begin{align*}
...
We now show that the optimality gap of Nesterov Accelerated FedAvg has $\mathcal{O}(1/\sqrt{KT})$ rate. This result complements the strongly convex case in the previous
