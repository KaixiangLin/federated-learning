...
% \input{sec_conclude}
\lkxcom{questions and todo: \\
1. Sec~\ref{sec:app:comparison}. O(E/NT) or O(E/KT)  when N
K = O(N).
2. Communication complexity in~\cite{karimireddy2019scaffold} for full participation, no restriction?
3. shrink to 8 pages.
}
