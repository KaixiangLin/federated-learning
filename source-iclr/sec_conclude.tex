...
convex smooth problems. We further prove that FedAvg can achieve geometric convergence for overparameterized strongly convex smooth problems. We also propose a new variant of FedAvg with momentum updates (FedMaSS), which has provable speedup in geometric convergence rate over FedAvg on quadratic problems. Last but not least, extensive empirical 
