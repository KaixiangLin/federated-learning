...
sampling schemes to simulate practical scenarios~\cite{li2019convergence}. For example, Sampling scheme I establishes $\cS_{t+1}$ by i.i.d. sampling the devices with probability $p_k$ with replacement. 
Both schemes
...
works in federated learning\cite{yu2019parallel,li2019convergence,stich2018local}. We provide one more justification for their generality: even though they require bounds for all $\mathbf{w}$,
