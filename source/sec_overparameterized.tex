...
Lastly, we deal with the question of whether FedAvg with momentum-based
...
When $N=\mathcal{O}(\kappa_{1})$, the convergence rate is $\mathcal{O}((1-\frac{N}{E\kappa_{1}})^{t})=\mathcal{O}(\exp(-\frac{N}{E\kappa_{1}}t))$,
