...
we report the last iteration to converge to $\epsilon$-accuracy of Nesterov accelerated FedAvg. The empirical observations align with our theorems \lkxcom{cite accelerated theorems} that the accelerated version of FedAvg can also achieve the linear speedup
