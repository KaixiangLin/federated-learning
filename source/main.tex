...
comprehensive convergence analysis on Federated Averaging (FedAvg), a widely used framework in which SGD or Nesterov SGD updates are used with arbitrarily heterogeneous data. 
