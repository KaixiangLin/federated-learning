...
% Assume Assumption~\ref{ass:subgrad2}, $\eta_t$ is non-increasing, and $\eta_t \leq 2\eta_{t+E}$ for all $t\geq 0$, according to Lemma 3 in~\cite{li2019convergence}, we have
